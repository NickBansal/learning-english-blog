...
export const headerLinksMobile = ({ isActive }: Props) =>
  isActive
    ...
    : 'border-transparent text-gray-300 hover:Lbg-gray-50 hover:border-gray-300 hover:text-gray-300 block pl-3 pr-4 py-2 bl-4 text-base font-medium dark:text-white" dark:hover:bg-gray-600';
