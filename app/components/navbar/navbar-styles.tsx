...
export const headerLinksMobile = ({ isActive }: Props) =>
  isActive
    ...
    : 'border-transparent text-gray-500 hover:bg-gray-200 hover:border-gray-300 hover:text-gray-600 block pl-3 pr-4 py-2 bl-4 text-base font-medium dark:text-white" dark:hover:bg-gray-600';
