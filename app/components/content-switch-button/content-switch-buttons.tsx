...
export const ContentSwitcher = ({ videoContent }: { videoContent: boolean }) => {
  ...
  const selectedBtn =
    'border-2 border-gray-500 bg-teal-600 text-white dark:bg-gray-500 dark:text-gray-300 dark:border-gray-200';
  const notSelectedBtn =
    'text-teal-600 dark:text-teal-300 hover:text-gray-200 hover:bg-teal-500 dark:hover:bg-gray-300 dark:hover:text-gray-500';
